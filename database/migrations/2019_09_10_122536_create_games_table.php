...
class CreateGamesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('games', function (Blueprint $table) {
            ...
            // $table->string('version',200)->comment('游戏版本');
            // $table->string('product_name',100)->nullable(true)->comment('产品名称');
            $table->string('sdk_server',100)->nullable(true)->comment('sdk服务器');
            $table->string('sdk_ios',50)->nullable(true)->comment('ios sdk 版本');
            $table->string('unity_version',50)->nullable(true)->comment('Unity3D版本');
            // $table->string('sdk_android',50)->nullable(true)->comment('安卓版本');
            // $table->unsignedBigInteger('android_sign')->nullable(true)->comment('Android默认签名');
            $table->unsignedBigInteger('unity_enc')->nullable(true)->comment('unity 加密');
            $table->unsignedBigInteger('userId')->nullable(true)->comment('用户id');
